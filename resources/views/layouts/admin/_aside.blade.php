...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        {{--home--}}
        <li><a class="app-menu__item {{ request()->is('*home*') ? 'active' : '' }}" href="{{route('admin.home')}}"><i class="app-menu__icon fa fa-home"></i><span class="app-menu__label">{{ trans('site.home') }}</span></a></li>
        ...
        <li><a class="app-menu__item {{ request()->is('*admins*') ? 'active' : '' }}" href="{{route('admin.admins.index')}}"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">{{ trans('admins.admins') }}</span></a></li>     
        @endif

        {{--users--}}
        @if (auth()->user()->isAbleTo('read_users'))
        <li><a class="app-menu__item {{ request()->is('*users*') ? 'active' : '' }}" href="{{route('admin.users.index')}}"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">{{ trans('users.users') }}</span></a></li>     
        @endif

        {{--genres--}}
        @if (auth()->user()->isAbleTo('read_genres'))
        ...
        {{--settings--}}
        @if (auth()->user()->isAbleTo('read_settings'))
